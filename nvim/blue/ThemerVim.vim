  ...
  let s:guishade0 = "#242b36"
  let s:guishade1 = "#434953"
  let s:guishade2 = "#63686f"
  let s:guishade3 = "#82868c"
  let s:guishade4 = "#a1a4a9"
  let s:guishade5 = "#c0c2c6"
  let s:guishade6 = "#e0e1e2"
  let s:guishade7 = "#ffffff"
  let s:guiaccent0 = "#fd2e59"
  let s:guiaccent1 = "#ff716a"
  let s:guiaccent2 = "#ffbf40"
  let s:guiaccent3 = "#6ccc2d"
  let s:guiaccent4 = "#21c7ca"
  let s:guiaccent5 = "#3b96ff"
  let s:guiaccent6 = "#8394ff"
  let s:guiaccent7 = "#ff1aba"
  ...
  let s:guishade1 = "#e0dde0"
  let s:guishade2 = "#c2bfc2"
  let s:guishade3 = "#a3a0a3"
  let s:guishade4 = "#848285"
  let s:guishade5 = "#656366"
  let s:guishade6 = "#474548"
